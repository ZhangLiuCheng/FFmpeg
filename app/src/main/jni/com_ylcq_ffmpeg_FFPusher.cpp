...
#include "com_ylcq_ffmpeg_FFPusher.h"
#include "log_util.h"
...
int y_size;
int framecnt = 0;
char filename_out[] = "/storage/emulated/0/Android/data/com.ylcq.ffmpeg/cache/camera.h264";
...
//    jbyte *yuv420sp = (jbyte*) env->GetByteArrayElements(yuvdata, 0);
